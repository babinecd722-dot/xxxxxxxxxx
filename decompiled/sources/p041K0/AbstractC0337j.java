...
public abstract class AbstractC0337j {
    ...
    /* renamed from: a */
    public static final C0163b0 f701a;
    ...
    static {
        ...
        AbstractC0194r.m537c(192, objArr);
        f701a = AbstractC0143I.m492h(192, objArr);
    }

    /* renamed from: a */
    public static String m682a(int i2) {
        if (i2 >= 0) {
            C0163b0 c0163b0 = f701a;
            if (i2 < c0163b0.size()) {
                return (String) c0163b0.get(i2);
            }
        }
        return null;
    }
