...
## RakSAMP Lite + blast.hk (Lua)

Сборка **не** из GitHub — архив **`RakSAMP Lite.zip`** из темы [RakSAMP Lite](https://www.blast.hk/threads/108052/), скрипты и гайд: **`raksamp/lite/BLAST_LITE_SETUP.md`**. Запуск под Wine: **`./run_lite_wine.sh`**.
