-- Объединение aim_fix_updated.lua + send_ping_fix.lua для RakSAMP Lite (один onLoad / onSendPacket).
-- Исходники: Ulong / форум blast.hk — не менять логику, только склейка колбэков.
...
-- === aim_fix (глобальные) ===
local CREDITS = {AUTHOR = "Ulong", SCRIPT_VERSION = "1.2-merged"}
...
function onSendPacket(id, bs)
	-- send_ping_fix + aim_fix на одном PlayerSync/VehicleSync
