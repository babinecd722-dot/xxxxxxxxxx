...
mod.uint8 = {
	...
	write = function(bs, value) return bs:writeUInt8(value) end
}

mod.uint16 = {
	read = function(bs) return bs:readUInt16() end,
	write = function(bs, value) return bs:writeUInt16(value) end
}
